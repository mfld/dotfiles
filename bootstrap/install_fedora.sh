...
i tilix gnome-tweaks vim-enhanced neovim ffmpeg htop ncdu perl-HTML-Parser gnome-extensions-app \
  ...
  @multimedia usbutils gvfs-mtp plymouth-theme-breeze plymouth-system-theme rsync fzf gnome-icon-theme nvtop tree libva-utils bind9-next-utils mesa-vulkan-drivers gnome-pomodoro unzip
